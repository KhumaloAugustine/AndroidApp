...
@Composable
fun RegisterActivity(authViewModel: AuthViewModel = viewModel()) {
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.register_title), // Replace with your own string resource
        ...
        Button(
            onClick = {
                ...
                // Show registration success message or navigate to the login screen
            },
            modifier = Modifier.padding(top = 16.dp)
        ) {
            Text(text = stringResource(R.string.register_button_label)) // Replace with your own string resource
        }
    }
}
